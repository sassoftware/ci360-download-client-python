...
| -st, --start           | The start value in this datetime format: `yyyy-mm-ddThh`. For example: `2025-04-01T00`<br><br>**Note:** To download data for an entire day (that is, starting at 12:00 AM), make sure that the final two digits (for hour) are zeros. |
| -et, --end             | The end value in this datetime format: `yyyy-mm-ddThh`. For example: `2025-04-03T14`   |
| -ct, <br>--category        | The category of tables to download. When the parameter is not specified, you download tables for all the categories that you have a license to access.<br><br>To download tables from a specific category, you can use one of these values:<ul><li>audience</li><li>cdm</li><li>destinations</li><li>discover</li><li>engagedigital</li><li>engagedirect</li><li>engageemail</li><li>engagemetadata</li><li>engagemobile</li><li>engageweb</li><li>metadata_all</li><li>optoutdata</li><li>plan</li><li>sms</li><li>usage</li></ul><br>For more information, see [Categories for Data Tables](https://documentation.sas.com/?softwareId=ONEMKTMID&softwareVersion=production.a&requestor=inapp&softwareContextId=downloadAPISchemas) in the *Administration Guide*.<br><br>**Note:** Do not use the categories `engagemetadata`, `metadata_all`, `plan`, or `usage` with the mart values `detail` or `dbt`. These categories are associated with the `snapshot` mart.| 
